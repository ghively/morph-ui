...
describe('EmptyState', () => {
  it('renders title inside [data-eyebrow]', () => {
  ...
  it('no children -> body div absent', () => {
    ...
    const bodyDiv = container.querySelector('[data-empty] > div:not([data-tile]):not([data-eyebrow])');
  ...
  it('framed -> [data-notconfigured] wrapper with exact attributes', () => {
    ...
    expect(wrapper.getAttribute('data-card')).toBe('');
  ...
  it('live -> [data-dot] has data-live attribute', () => {
